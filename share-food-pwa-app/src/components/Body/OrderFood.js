...
const OrderFood = ({idx, order}) => {
    ...
    const Unaccept = async() => {
        const deleteOrder = await axios.delete(`${apiUrl}/post/update/${order._id}`)
    ...
    return (
        <>
            ...
            <td>
                <Button className="button-approval button-approval-accept" onClick={Accept}>
                    <FontAwesomeIcon icon={faCheck} />
                </Button>
                <Button className="button-approval button-approval-unaccept btn-danger" onClick={Unaccept}>
